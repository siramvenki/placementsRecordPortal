...
<head>
  ...
  $("#login_btn").click(function(){
      ...
      url: 'signUpTest.php',
      type: 'POST',
      data: {'email': email, 'name': userName, 'rollNo': rollNo, 'password': password, 'rePassword': rePassword , 'mobile' : mobile},
...
<div class="row center">
    <form class="col s12 center">
      ...
      <div class="row">
        <div class="input-field col s12">
          <input id="mobile" name="mobile" type="number" size="11" class="validate">
      ...
      <div class="row">
        <div class="input-field col s12">
          ...
          <label for="profession">Enter Roll No</label>
        </div>
      </div>
      ...
      <div class="row">
        <div class="input-field col s12">
          ...
          <button class="btn waves-effect waves-light green col s5 l5 m5 left" type="button" id="login_btn">Sign up </button>
